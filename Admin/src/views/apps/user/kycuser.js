...
class UsersList extends React.Component {
    ...
    columnDefs: [
      ...
      },
      {
        ...
        cellRendererFramework: params => {
          return (
            <div className="actions cursor-pointer">
              {params.value.fname} {params.value.mname} {params.value.lname}
            </div>
          )
        }
      },
  ...
  async componentDidMount() {
    const urlaction = this.props.location.pathname+this.props.location.search;
    getAPICall(urlaction)
    .then(response => {
