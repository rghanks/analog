...
class UsersList extends React.Component {
  ...
  async componentDidMount() {
    ...
    let params =  "?action=pending&raw=0&admin_user_id="+this.state.currentUserId+"&per_page="+this.state.pageSize+"&page=1";
          ...
          <CardBody style={{ height: "85vh" }}>
              <div className="ag-theme-material ag-grid-table" style={{ height: "80vh" }}>
                <div className="ag-grid-actions d-flex justify-content-between flex-wrap mb-1">
                  ...
                  <div className="">
                    <div className="h2 float-left">Total Bank Pending KYC : {this.state.rowData !== null ? this.state.rowData.totalCount : 0 }</div>
                  </div>
