...
class UsersList extends React.Component {
  ...
  async componentDidMount() {
    let params =  "?action=approved&raw=0&admin_user_id="+this.state.currentUserId+"&per_page="+this.state.pageSize+"&page=1";
    ...
    if (this.state.gridApi !== prevState.gridApi) {
      const dataSource = {
        getRows: (rowData) => {
          ...
          let params = "?action=approved&raw=0&admin_user_id="+this.state.currentUserId+"&per_page=" + this.state.pageSize + "&page=" + page;
