...
class UsersList extends React.Component {
        ...
        cellRendererFramework: params => {
          return (
            <div className="actions cursor-pointer">
              <a target="_blank" href={`/app/wallets/adminsendcapture?capture_id=${params.data._id}`}
                className="mr-1"
              >
                Admin transfers
              </a> / <a target="_blank" href={`/app/wallets/capturefundhistory?capture_id=${params.data._id}`}
                className="ml-1"
              >
                Captured User
              </a>
  ...
  async componentDidMount() {
    const body = {
      ...
      postAPICall('get-capture-hits', body).then((response) => {
        ...
        <Row className="app-user-list">
            ...
            <Card>
                ...
                <div className="ag-theme-material ag-grid-table">
                    ...
                    <div className="">
                    <div className="h2 float-left">Total Captured : {this.state.rowData !== null ? this.state.rowData.length : 0 }</div>
                  </div>
