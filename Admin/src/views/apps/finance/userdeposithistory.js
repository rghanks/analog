  ...
  state = {
    ...
    columnDefs: [
        ...
        cellRendererFramework: params => {
          return (
            <div className="actions cursor-pointer">
              {params.data.pending_kyc.length > 0 && params.data.pending_kyc[0].email ? params.data.pending_kyc[0].email : params.value}
            </div>
          )
        }
      },
      {
        ...
        cellRendererFramework: params => {
          let username = '';
          if(params.data.pending_kyc.length){
            username = params.data.pending_kyc[0]?.first_name ? username+ params.data.pending_kyc[0]?.first_name+' ' : '';
            username = params.data.pending_kyc[0]?.middle_name ? username+ params.data.pending_kyc[0]?.middle_name+' ' : '';    
            username = params.data.pending_kyc[0]?.last_name ? username+ params.data.pending_kyc[0]?.last_name+' ' : '';    
          }else{
