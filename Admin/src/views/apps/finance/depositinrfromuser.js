...
class DepositList extends React.Component {
  ...
  state = {
    ...
    columnDefs: [
      ...
      },
      {
        ...
        cellRendererFramework: params => {
          return (
            <Media className="mr-2 my-25" left target="_blank" href={BaseURL+params.data.screnshot}>
              show Screenshot
            </Media>
          )
      }
        ...
        cellRendererFramework: params => {
              return (
                <div className="actions cursor-pointer">
                  {params.value ==0 ? <> 
                    <Button.Ripple className="mr-1 btn-sm" color="success" onClick={() => {this.getApprove(params.data.user_id,params.data.email, params.data.amount, params.data.transection_id)}}>Approve</Button.Ripple>
                    <Button.Ripple className="mr-1 btn-sm" color="danger" onClick={() => {this.getDelete(params.data.user_id,params.data.email, params.data.amount, params.data.transection_id)}}>Reject</Button.Ripple>
  ...
  getApprove = (user_id, email, amount, transection_id) => {
    const body = {
  ...
  getDelete = (user_id, email, amount, transection_id) => {
    const body = {
      admin_user_id: this.state.currentUserId,
      transection_id: transection_id,
      type: 'deposit',
            ...
            <div className="ag-theme-material ag-grid-table">
              ...
              {this.state.rowData !== null ? (
                ...
                <>
                  ...
                  <h2 className="float-left ml-1">System is All Calculating Deposit Users.</h2>
                </>
              )}
            </div>
          </CardBody>
