                        ...
                        <div class="nk-sidebar-widget d-none d-xl-block">
                            <div class="user-account-info between-center">
                                <div class="user-account-main">
                                    ...
                                    <div class="user-balance">2.014095 <small class="currency currency-btc">ANA</small></div>
                                    <div class="user-balance-alt">18,934.84 <span class="currency currency-btc">USD</span></div>
                                </div>
                            ...
                            <ul class="user-account-data gy-1">
                                <li>
                                    ...
                                    <div class="user-account-value">
                                        <span class="lead-text">+ 0.0526 <span class="currency currency-btc">ANA</span></span>
                                ...
                                <li class="wallet-item">
                                    <a href="#">
                                        ...
                                        <div class="wallet-text">
                                            ...
                                            <span class="wallet-balance">30.959040 <span class="currency currency-nio">ANA</span></span>
                                        </div>
                                    </a>
                                </li>
                                <li class="wallet-item">
