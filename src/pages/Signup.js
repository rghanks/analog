    ...
    <div class="nk-split-content nk-block-area nk-block-area-column nk-auth-container bg-white">
        ...
        <div class="nk-block nk-block-middle nk-auth-body">
            ...
            <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-lg" id="default-01" placeholder="Create desired username" />
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-control-wrap">
                        ...
                        <input type="password" class="form-control form-control-lg" id="password" placeholder="Confirm your passcode" />
                    </div>
                </div>
            ...
            <div class="form-note-s2 pt-4"> Already Interact   <a href="#">Create an account</a>
            </div>
