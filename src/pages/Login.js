        ...
        <div class="nk-block nk-block-middle nk-auth-body">
            <div class="brand-logo pb-5">
                <a href="#" class="logo-link">
                    ...
                    <img class="logo-dark logo-img logo-img-lg" src="./images/logo.png" srcset="./images/logo-dark2x.png 2x" alt="logo-dark" />
                </a>
            </div>
            <div class="nk-block-head">
                <div class="nk-block-head-content">
                    ...
                    <div class="nk-block-des">
                        <p>Connect with <b>Analog Inceptive</b> of <b>INRX Blockchain</b>.</p>
                    </div>
                </div>
            </div>
            <form>
                ...
                <div class="form-group">
                    <button class="btn btn-lg btn-primary btn-block" onClick={()=> window.location.href= '/faq'}>Sign in</button>
                </div>
            </form>
                ...
                <div class="slider-item">
                    <div class="nk-feature nk-feature-center">
                        <div class="nk-feature-img">
                            <img class="round" src="./images/slides/slide-a.png" srcset="./images/slides/promo-a2x.png 2x" alt="" />
                        </div>
