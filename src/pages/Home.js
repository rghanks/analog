                            ...
                            <div class="nk-block-head">
                                ...
                                <div class="nk-block-between-md g-4">
                                    <div class="nk-block-head-content">
                                        <h2 class="nk-block-title fw-normal">Ia5ghTL2paqchJTR65nBKvZ</h2>
...
<divx></divx>
                                    ...
                                    [<b>Energy</b> <span style={{color:"green"}} class="timer">5,6881.00 </span> J]
                                    </div>  
                                </div>
                            </div>
                            <div class="nk-block">
                                    ...
                                    <div class="col-lg-7 col-xl-8">
                                        <div class="nk-block">
                                            <div class="nk-block-head-xs">
                                                <div class="nk-block-between-md g-2">
                                                    <div class="nk-block-head-content">
                                                        <h5 class="nk-block-title title">INCEPTIVE WALLETS</h5>
                                                    </div>
                                                    <div class="nk-block-head-content">
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="nk-wgw sm">
                                                            <a class="nk-wgw-inner" href="html/crypto/wallet-bitcoin.html">
                                                                <div class="nk-wgw-name">
                                                                    ...
                                                                    <h5 class="nk-wgw-title title">SALVAGE</h5>
                                                                </div>
                                                                <div class="nk-wgw-balance">
                                                                    <div class="amount">4.434953<span class="currency currency-nio">ANA</span></div>
                                                                </div>
                                                            </a>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="nk-wgw sm">
                                                            <a class="nk-wgw-inner" href="html/crypto/wallet-bitcoin.html">
                                                                <div class="nk-wgw-name">
                                                                    ...
                                                                    <h5 class="nk-wgw-title title">AFFILIATES</h5>
                                                                </div>
                                                                <div class="nk-wgw-balance">
                                                                    <div class="amount">4.434953<span class="currency currency-btc">ANA</span></div>
                                                                </div>
                                                            </a>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="nk-wgw sm">
                                                            <a class="nk-wgw-inner" href="#">
                                                                <div class="nk-wgw-name">
                                                                    ...
                                                                    <h5 class="nk-wgw-title title">PLEBISCITE </h5>
                                                                </div>
                                                                <div class="nk-wgw-balance">
                                                                    <div class="amount">0.000560<span class="currency currency-eth">ANA</span></div>
                                                                </div>
                                                            </a>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="nk-block nk-block-md">
                                            <div class="nk-block-head-xs">
                                                <div class="nk-block-between-md g-2">
                                                    <div class="nk-block-head-content">
                                                        <h6 class="nk-block-title title">CURRENT GROWTH RATE  %</h6>
                                                    </div>
                                                    <div class="nk-block-head-content">
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="card bg-light">
                                                        <div class="nk-wgw sm">
                                                            <a class="nk-wgw-inner" href="#">
                                                                ...
                                                                <div class="nk-wgw-balance">
                                                                    <div class="amount">1.5%<span class="currency currency-nio"></span></div>
                                                                </div>
                                                            </a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card bg-light">
                                                        <div class="nk-wgw sm">
                                                            <a class="nk-wgw-inner" href="html/crypto/wallet-bitcoin.html">
                                                                ...
                                                                <div class="nk-wgw-balance">
                                                                    <div class="amount" style={{fontSize:"10px"}}>[L<sup>1</sup> / L<sup>2</sup> / L<sup>3</sup>][1% / 0.5% / 0.2% ]<span class="currency currency-btc"></span></div>
                                                                </div>
                                                            </a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card bg-light">
                                                        <div class="nk-wgw sm">
                                                            <a class="nk-wgw-inner" href="html/crypto/wallet-bitcoin.html">
                                                                ...
                                                                <div class="nk-wgw-balance">
                                                                    <div class="amount">0.5%<span class="currency currency-eth"></span></div>
                                                                </div>
                                                            </a>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="tranx-list card card-bordered">
                                            <div class="tranx-item">
                                                <div class="tranx-col">
                                                    <div class="tranx-info">
                                                        <div class="tranx-data">
                                                            <div class="tranx-label">Buy ANA <em class="tranx-icon sm icon ni ni-sign-btc"></em></div>
                                                ...
                                                <div class="tranx-col">
                                                    <div class="tranx-amount">
                                                        <div class="number">5384 <span class="currency currency-btc">ANA</span></div>
                                            ...
                                            <div class="tranx-item">
                                                <div class="tranx-col">
                                                    <div class="tranx-info">
                                                        <div class="tranx-data">
                                                            <div class="tranx-label">Buy Shield <span class="tranx-icon sm"><img src="images/coins/eth.svg"    alt=""/></span></div>
                                                            <div class="tranx-date">Nov 12, 2019 11:34 PM</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="tranx-col">
                                                    <div class="tranx-amount">
                                                        <div class="number">17.6 <span class="currency currency-btc">ANA</span></div>
                                            ...
                                            <div class="tranx-item">
                                                <div class="tranx-col">
                                                    <div class="tranx-info">
                                                        <div class="tranx-data">
                                                            <div class="tranx-label">Buy ET <em class="tranx-icon sm icon ni ni-sign-btc"></em></div>
                                                            <div class="tranx-date">Nov 12, 2019 11:34 PM</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="tranx-col">
                                                    <div class="tranx-amount">
                                                        <div class="number">1000 <span class="currency currency-btc">ANA</span></div>
                                                        <div class="number-sm">3,980.93 <span class="currency currency-usd">USD</span></div>
                                                    </div>
                                                </div>
                                            </div>  
                                            <div class="tranx-item">
                                                <div class="tranx-col">
                                                    <div class="tranx-info">
                                                        <div class="tranx-data">
                                                            <div class="tranx-label">Sell ANA <span class="tranx-icon sm"><img src="images/coins/eth.svg"    alt=""/></span></div>
                                                            <div class="tranx-date">Nov 12, 2019 11:34 PM</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="tranx-col">
                                                    <div class="tranx-amount">
                                                        <div class="number">1.538405 <span class="currency currency-btc">ANA</span></div>
                                                        <div class="number-sm">1,176.34 <span class="currency currency-usd">USD</span></div>
                                                    </div>
                                                </div>
                                            </div>  
                                        ...
                                        <div class="nk-refwg-invite card-inner">
                                            ...
                                            <div class="nk-refwg-url">
                                                <div class="form-control-wrap">
                                                    ...
                                                    <input type="text" class="form-control copy-text" id="refUrl" value="https://inceptive.network/?ref=Ia5ghTL2paqchJTR65nBKvZ"  />
                                                </div>
                                            </div>
                                        </div>  
